...
ros::Subscriber<std_msgs::Bool> drop_signal("/Quad2/gripper_command", &sub); //  Subscriber declaration
ros::Publisher decision("/Quad2/gripper_status",&decision_msg);  //  Publisher "gripper_status" declaration
